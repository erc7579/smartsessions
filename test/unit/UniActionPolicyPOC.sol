...
contract UniversalActionPolicyTest is BaseTest {
    ...
    function test_use_universal_action_policy_success_two_recipients(bytes32 salt)
        public
        returns (PermissionId permissionId)
    {
        ...
        permissionId = _enableSessionWithUniActionPolicy(salt, instance.account, bob, 1e32, bytes32(uint256(0x01)));
    ...
    function test_use_universal_action_policy_success_two_recipientsV2(bytes32 salt)
        public
        returns (PermissionId permissionId)
    {
        uint256 valToAdd = 2517;
        ...
        permissionId = _enableSessionWithUniActionPolicyV2(salt, instance.account, bob, 1e32, bytes32(uint256(0x01)));
        bytes memory callData = abi.encodeCall(MockCallee.addBalance, (instance.account, valToAdd, valToAdd32));
        ...
        returns (PermissionId permissionId)
    {
        ...
        PolicyData[] memory actionPolicyDatas = new PolicyData[](2);
        bytes memory uniPolicyInitData1 = _getMockUniPolicyInitData(actionId, refAddressRef, refUint256, refBytes32);
        actionPolicyDatas[0] = PolicyData({ policy: address(uniPolicy), initData: uniPolicyInitData1 });
        bytes memory uniPolicyInitData2 = _getMockUniPolicyInitData(actionId, spender, refUint256, refBytes32);
        actionPolicyDatas[1] = PolicyData({ policy: address(uniPolicy), initData: uniPolicyInitData2 });
    ...
    function _enableSessionWithUniActionPolicyV2(
        bytes32 salt,
        address refAddressRef,
        address spender,
        uint256 refUint256,
        ...
        returns (PermissionId permissionId)
    {
        ...
        bytes memory uniPolicyInitData2 = _getMockUniPolicyInitData(actionId, spender, refUint256, refBytes32);
        actionPolicyDatas[0] = PolicyData({ policy: address(uniPolicy), initData: uniPolicyInitData2 });
