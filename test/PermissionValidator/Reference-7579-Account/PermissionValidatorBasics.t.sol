...
import { PermissionValidator } from "contracts/validators/PermissionValidator.sol";

contract PermissionValidatorBaseTest is RhinestoneModuleKit, Test {
    using ModuleKitHelpers for *;
    using ModuleKitUserOp for *;

    // account and modules
    AccountInstance internal instance;
    PermissionValidator internal validator;
    ...
    function setUp() public {
        ...
        vm.label(address(validator), "PermissionValidator");

        // Create the account and install the validator
        instance = makeAccountInstance("PermissionValidator");
