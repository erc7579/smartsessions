...
import { IValidator, VALIDATION_SUCCESS, VALIDATION_FAILED, MODULE_TYPE_VALIDATOR } from "erc7579/interfaces/IERC7579Module.sol";
...
contract MockValidator is IValidator {
    ...
    function isValidSignatureWithSender(address, bytes32 hash, bytes calldata signature) external view returns (bytes4) {
        ...
        // OR USE EIP-712
        return SignatureCheckerLib.isValidSignatureNowCalldata(owner, hash, signature) ? EIP1271_MAGIC_VALUE : ERC1271_INVALID;
    }
